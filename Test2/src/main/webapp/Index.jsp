...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="#"> <img src="logo.png" width="100"
			height="40" class="d-inline-block align-top" alt="Logo">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link"
					href="RegistrationDisplay.jsp">Registration Form</a></li>
			</ul>
		</div>
		<form action="form" method="post" class="container" name="myForm"
			...
			<div class="design">
				<label for="Mname">Middle Name</label><br> <span
					...
					onblur="LnameValidaiton()" type="text" name="Mname"
					class="form-control" id="Mname" placeholder=" Enter Mname">
			</div>
			<br>
			<div class="design">
			...
			<div class="gender">
				<label for="gender">Gender</label><br> <span id="genderError"
					style='color: red;'></span> <select id="gender" class="form-select"
					name="gender" onchange="genderValidation()"
			...
			<br>
			<div class="distic">
				<label for="distic">Distic</label><br> <span id="disticError"
					style='color: red;'></span> <select id="distic" class="form-select"
					name="distic" onchange="disticValidation()"
			...
			<div class="design">
				<label for="pincode">Pin Code</label><br> <span
					id="pincodeError" style='color: red;'></span> <input type="pincode"
					name="contactNo" id="pincode" onchange="mobileNumberValidation()"
					onkeypress="pincodeValidation()" placeholder=" Enter Pin Code">
			</div>
			<br>
