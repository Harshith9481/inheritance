...
public class Mechanic {
	...
	public String toString()
	{
		...
		return "name :" +name +"location :" +location +"ownerName :" +ownerName +"noOfItems :" +noOfItems +"costPerItem :" +costPerItem +"timeToRepair :" +timeToRepair;
	}
	@Override
	public boolean equals(Object obj)
	{
		if(obj!=null)
		{
			...
			if(obj instanceof Mechanic)
			{
				...
				if(koppa.name.equals(this.name)&&koppa.location==(location)&&koppa.ownerName.equals(this.ownerName)&&koppa.noOfItems==(this.noOfItems));
				{
