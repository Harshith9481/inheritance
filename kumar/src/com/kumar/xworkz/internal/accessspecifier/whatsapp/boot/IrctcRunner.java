...
import com.kumar.xworkz.internal.accessspecifier.whatsapp.Irctc;
...
public class IrctcRunner {
    ...
    ticket.setPassengerName("Harshith Kumar N R");
    ticket.setTrainName("janShatabdi Express");
    ticket.setSourceStation("Banglore");
    ticket.setDestinationStation("Manglore");
